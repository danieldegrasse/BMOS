...
const uint32_t exception_vectors[] __attribute__((section(".vectors"))) = {
    ...
    (uint32_t)DefaultISRHandler, /*!< 24 TIM1 Break interrupt and TIM15 global interrupt */
    (uint32_t)DefaultISRHandler, /*!< 25 TIM1 Update Interrupt and TIM16 globalinterrupt*/
    (uint32_t)DefaultISRHandler, /*!< 26 TIM1 Trigger and Commutation Interrupt */
    ...
    0,                           /*!< 53 Reserved */
    (uint32_t)DefaultISRHandler, /*!< 54 TIM6 global and DAC1&2 underrun error interrupts */
    ...
    (uint32_t)DefaultISRHandler, /*!< 74 Serial Audio Interface 1 global interrupt */
    0,                           /*!< 75 Reserved */
    (uint32_t)DefaultISRHandler, /*!< 76 Serial Wire Interface 1 global interrupt */
    (uint32_t)DefaultISRHandler, /*!< 77 Touch Sense Controller global interrupt */
